...
const AddInteraction = ({ addNew, added, setAdded, editData, onClose, sendUpdateToExploreCard }) => {
    ...
    return (
        <>
            <div className="w-1/3 rounded-2xl bg-[#18181b] border border-[#333] text-white shadow-xl p-6 space-y-4">
