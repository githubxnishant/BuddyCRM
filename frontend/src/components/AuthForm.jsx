    ...
    return (
        <div className="min-h-screen bg-[#1e1e1e] flex items-center justify-center px-4">
            <div className="bg-[#111] text-white w-full max-w-md p-8 rounded-lg shadow-lg">
                ...
                <button className="w-full flex items-center justify-center gap-2 bg-transparent border border-gray-600 text-white px-4 py-2 rounded mb-3 hover:bg-gray-800">
                ...
                <p className="text-center text-sm mt-4 text-gray-400">
                    {bottomText}{" "}
                    <Link to={linkText?.href} className="text-indigo-400 hover:underline">
                        {linkText?.label}
                    </Link>
                </p>
